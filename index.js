...
bot.command('start', async ctx => {
	...
	await ctx.reply('Привет! Я - Frontend Couch Bot 🤖 \nЯ помогу тебе подготовиться к собеседованию на Frontend разработчика')

	await ctx.reply('С какой темы начнем? Выбери тему вопроса в меню 👇', {
